...
public class CustomAddCgpaAlertDialog extends AppCompatDialogFragment
{
    private TextInputLayout Name_tag;
    private TextInputLayout Credits;
    private TextInputLayout Gpa;
    private CustomAddCgpaAlertDialog.CustomAddCgpaAlertDialogListener listener;
    DatabaseHelperCgpa StudentDatabase;
    public CustomAddCgpaAlertDialog()
    {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState)
    {
        ...
        View view = inflater.inflate(R.layout.custom_add_cgpa_dialog,null);
                ...
                .setPositiveButton("Add", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        if(!StudentDatabase.checkAlreadyExist(name_tag))
                            listener.ApplyAddCgpaDataText(name_tag,credits_value,gpa_value);
                        else
                        {
    ...
    public void onAttach(@NonNull Context context) {
        ...
        try
        {
            listener = (CustomAddCgpaAlertDialog.CustomAddCgpaAlertDialogListener) context;
        }
    ...
    public interface CustomAddCgpaAlertDialogListener
    {
        void ApplyAddCgpaDataText(String name_tag,String credits,String gpa);
    }
}
