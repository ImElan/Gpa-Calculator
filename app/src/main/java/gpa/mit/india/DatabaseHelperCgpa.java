...
public class DatabaseHelperCgpa extends SQLiteOpenHelper
{
    private static final String DatabaseName = "CGPAResults.db";
    private static final String TableName = "students_cgpa_table";
    ...
    private static final String COL_4 = "CGPA";

    public DatabaseHelperCgpa(@Nullable Context context)
    {
    ...
    {
        String createTable = "CREATE TABLE " + TableName + "(NAME_TAG TEXT , CREDITS TEXT , CGPA TEXT)";
    ...
    boolean AddData(String name_tag,String Credits,String CGPA)
    {
